...
public class Oberflaeche extends JFrame {
  ...
  private JTabbedPane tabBar = new JTabbedPane(JTabbedPane.TOP, JTabbedPane.SCROLL_TAB_LAYOUT);
  ...
  public Oberflaeche(String title){
	...
	try {
    	Image applicant = ImageIO.read(getClass().getResource("resources/applicant.png"));
	...
	try {
		Image pencil = ImageIO.read(getClass().getResource("resources/pencil.png"));
	...
	panelButton2.add(buttonDelete);
  	...
  	try {
  		Image trashcan = ImageIO.read(getClass().getResource("resources/trashcan.png"));
  	...
  	try {
  		Image settings = ImageIO.read(getClass().getResource("resources/settings_big.png"));
  	...
  	try {
  		Image close = ImageIO.read(getClass().getResource("resources/close_big.png"));
	...
	menuHelp.add(itemAbout);
	  try {
		    Image close = ImageIO.read(getClass().getResource("resources/close.png"));
		    itemExit.setIcon(new ImageIcon(close));
		  } catch (IOException ex) {
		  }
	  try {
		    Image plus = ImageIO.read(getClass().getResource("resources/plus.png"));
		    itemApplicant.setIcon(new ImageIcon(plus));
		  } catch (IOException ex) {
		  }
	  try {
		    Image settings = ImageIO.read(getClass().getResource("resources/settings.png"));
		    itemChangeDesign.setIcon(new ImageIcon(settings));
		  } catch (IOException ex) {
		  }
	  try {
		    Image about = ImageIO.read(getClass().getResource("resources/about.png"));
    ...
    scrollPaneJob.setPreferredSize(new Dimension(panelContent3.getSize().width-20, panelContent3.getSize().height-15));
    scrollPaneJob.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
    scrollPaneJob.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
